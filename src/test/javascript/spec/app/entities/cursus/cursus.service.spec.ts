...
describe('Service Tests', () => {
    describe('Cursus Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Cursus(0, 'AAAAAAA', currentDate, currentDate, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Cursus', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        dateDebut: currentDate.format(DATE_FORMAT),
            ...
            it('should return a list of Cursus', async () => {
                const returnedFromService = Object.assign(
                    {
                        nom: 'BBBBBB',
                        dateDebut: currentDate.format(DATE_FORMAT),
