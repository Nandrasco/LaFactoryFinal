...
import { LaFactoryFinalCoreModule } from 'app/core';
import { LaFactoryFinalAppRoutingModule } from './app-routing.module';
...
@NgModule({
    imports: [
        ...
        LaFactoryFinalSharedModule.forRoot(),
        LaFactoryFinalCoreModule,
...
export class LaFactoryFinalAppModule {
